 ...
 <head>
  ...
  <script type="text/javascript">
   ...
   function doDetail(seq) {
      location.href = "/user/adminuserInfo.do?usr_seq_no=" + seq;
   }
...
<%=paging.getPage_count()%>
   ;
      location.href = "/user/adminuserTable.do?pageCount=" + pageCount
            + "&pageNum=" + page;
   }
</script>
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <div class="navbar-toggle">
             ...
             <p style="font-size:20pt;">회원정보게시판</p>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> 회원정보게시판</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                     <thead class="text-primary">
                                            ...
                                            <th scope="cols" width="100" align="center">이름</th>
                                            <th scope="cols" width="100" align="center">아이디</th>
                                            <th scope="cols" width="100" align="center">비밀번호</th>
                                            <th scope="cols" width="100" align="center">닉네임</th> 
                                            <th scope="cols" width="100" align="center">생년월일</th>
                                        </thead>
                     <tbody>
                                           <%
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td ><%=CmmUtil.nvl(rDTO.getUsr_name())%></td>
                              <td ><a href="javascript:doDetail('<%=CmmUtil.nvl(rDTO.getUsr_seq_no())%>');"><%=CmmUtil.nvl(rDTO.getUsr_id())%></a></td>
                              <td ><%=CmmUtil.nvl(rDTO.getPassword())%></td>
                              <td ><%=CmmUtil.nvl(rDTO.getUsr_nickname())%></td>
                              <td ><%=CmmUtil.nvl(rDTO.getUsr_birthdate())%></td>
                           </tr>
                        </tbody>
                        <%}%>
                  </table>
