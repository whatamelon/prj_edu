 ...
 <head>
  ...
  <script type="text/javascript">
   ...
   function doDetail(seq) {
      location.href = "/user/engContent.do?post_seq_no=" + seq;
   }
...
<%=paging.getPage_count()%>
   ;
      location.href = "/user/engTable.do?pageCount=" + pageCount
            + "&pageNum=" + page;
   }
</script>
<script>
function doDelete(num){
	   if ("<%=edit%>"==2){
	      if(confirm("작성한 글을 삭제하시겠습니까?")){
	         location.href="/user/adminengDelete.do?post_seq_no="+num;
	      }
