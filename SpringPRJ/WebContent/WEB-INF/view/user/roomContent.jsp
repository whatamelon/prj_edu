...
function doDelete(){
   if ("<%=edit%>"==2){
      if(confirm("작성한 글을 삭제하시겠습니까?")){
         location.href="/user/roomDelete.do?post_seq_no=<%=CmmUtil.nvl(nDTO.getPost_seq_no())%>";
      }
...
//목록으로 이동
function doList(){
   location.href="/user/roomTable.do";
                ...
                <h4 class="card-title">평가글보기</h4>
							...
							<div class="card-body">
								<div class="table-responsive">
								 <form action ="/user/roomChange.do" id="doEdit" method="post" >
									...
									<table class="table table-bordered">
										<tbody>
												...
												<tr>
													<td>
													<label style="font-size:1.2571em;">지역</label>
													<input type="text"  name="city" class="form-control" placeholder="<%=CmmUtil.nvl(nDTO.getCity())%>" 
													style="background-color:transparent; font-size:20px;" readonly />
													</td>
													<td >
													<label style="font-size:1.2571em;">닉네임</label>
													<input type="text"  name="usr_nickname" class="form-control" placeholder="<%=CmmUtil.nvl(nDTO.getUsr_nickname())%>" 
													style="background-color:transparent; font-size:20px;" readonly />
													</td>
												</tr>
												<tr>
													<td colspan="2"><textarea cols="10" placeholder="<%=CmmUtil.nvl(nDTO.getContents())/* .replaceAll("\r\n", "<br/>") */ %> "
													 name="contents" class="form-control" style="background-color:transparent;"></textarea>
													</td>
												</tr>
												<tr>
													<td colspan="3">
