...
function doDelete(){
   if ("<%=edit%>"==2){
      if(confirm("작성한 글을 삭제하시겠습니까?")){
         location.href="/user/mathDelete.do?post_seq_no=<%=CmmUtil.nvl(nDTO.getPost_seq_no())%>";
      }
...
//목록으로 이동
function doList(){
   location.href="/user/mathTable.do";
                ...
                <h4 class="card-title">평가글보기</h4>
							...
							<div class="card-body">
								<div class="table-responsive">
								 <form action ="/user/mathChange.do" id="doEdit" method="post" >
