...
<body>
	...
	<div class="container">
		...
		<a class="navbar-brand" style="color:#000000;  font-size:50px; ">비밀번호 찾기</a>
	</div>
  ...
  <input style="font-size:20px; font-weight:bold;" type="text" name="name" id="id" maxlength="10" placeholder="아이디" required/><br>
  ...
  <button style="font-size:25px; font-weight:bold;" type="button" onclick="check()" value=값입력 class="button">비밀번호찾기</button>
