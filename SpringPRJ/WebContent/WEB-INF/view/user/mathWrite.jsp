              ...
              <div class="card-header">
                <h4 class="card-title">평가 글쓰기</h4>
							...
							<div class="card-body">
								...
								<form action="/user/mathInsert.do" method="post" encType="multiplart/form-data" name="f" method="post" onsubmit="return doSubmit(this);">
									<table class="table table-bordered">
										<tbody>
												...
												<tr>
													...
													<input type="text" placeholder="선생님 이름을 입력해주세요. " name="teacher" class="form-control" />
													</td>
													<td>
