    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg fixed-top navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          ...
          <span style="width:130px;"><a href="/user/userInfoCheck.do" style="font-size:15px; text-decoration:none;">회원정보수정</a></span>
          
          <span style="width:90px;"><a href="/user/adminuserTable.do" style="font-size:15px; text-decoration:none;">회원관리</a></span>
