 ...
 <head>
  ...
  <script type="text/javascript">
   ...
   function doDetail(seq) {
      location.href = "/user/mathContent.do?post_seq_no=" + seq;
   }
...
<%=paging.getPage_count()%>
   ;
      location.href = "/user/mathTable.do?pageCount=" + pageCount
            + "&pageNum=" + page;
   }
</script>
<script>
function doDelete(num){
	   if ("<%=edit%>"==2){
	      if(confirm("작성한 글을 삭제하시겠습니까?")){
	         location.href="/user/adminmathDelete.do?post_seq_no="+num;
	      }
        ...
        <ul class="nav">
          ...
          <li class="active ">
            <a href="#">
              ...
              <p style="font-size:15pt; color:#A566FF;">수학 게시판</p>
            </a>
          </li>
          <li>
            <a href= "#">
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <div class="navbar-toggle">
             ...
             <p style="font-size:20pt;">수학게시판</p>
          ...
          <div class="col-md-12">
            <div class="card">
                ...
                <div class="table-responsive">
                  <table class="table">
                     <thead class="text-primary">
                     						<th scope="cols" width="30" align="center"></th>
                                            <th scope="cols" width="90" align="center">세부과목</th>
                                            <th scope="cols" width="90" align="center">선생님</th>
                                            <th scope="cols" width="90" align="center">제목</th>
                                            <th scope="cols" width="90" align="center">닉네임</th> 
                                            <th scope="cols" width="90" align="center">등록일</th>
                     ...
                     <tbody>
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td><a href="javascript:doDelete('<%=CmmUtil.nvl(rDTO.getPost_seq_no())%>');">[삭제]</a></td>
                           </tr>
                        </tbody>
                        <%}%>
                  </table>
              ...
              <div class="mid"  style="text-align:center;">
               ...
               <a href="/user/mathWrite.do">[글쓰기]</a>
            </div>
            </div>
          </div>
    </div>
