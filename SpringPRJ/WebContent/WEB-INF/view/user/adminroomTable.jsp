 ...
 <head>
  ...
  <script type="text/javascript">
   ...
   function doDetail(seq) {
      location.href = "/user/roomContent.do?post_seq_no=" + seq;
   }
...
<%=paging.getPage_count()%>
   ;
      location.href = "/user/roomTable.do?pageCount=" + pageCount
            + "&pageNum=" + page;
   }
</script>
<script>
function doDelete(num){
	   if ("<%=edit%>"==2){
	      if(confirm("작성한 글을 삭제하시겠습니까?")){
	         location.href="/user/adminroomDelete.do?post_seq_no="+num;
	      }
          ...
          <div class="col-md-12">
            <div class="card">
                ...
                <div class="table-responsive">
                  <table class="table">
                     <thead class="text-primary">
                     						...
                     						<th scope="cols" width="90" align="center">지역</th>
                     ...
                     <tbody>
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td ><%=CmmUtil.nvl(rDTO.getCity())%></td>
              ...
              <div class="mid" style="text-align:center;">
               ...
               <a href="/user/roomWrite.do">[글쓰기]</a>
            </div>
            </div>
          </div>
    </div>
